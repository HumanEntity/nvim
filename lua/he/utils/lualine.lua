...
function M.pretty_path(opts)
    ...
    return function(self)
        ...
        local root = require("he.utils.root").get({ normalize = true })
        local cwd = require("he.utils.root").cwd()
...
function M.root_dir(opts)
    opts = vim.tbl_extend("force", {
        ...
        other = true,
        icon = "󱉭 ",
        color = require("he.utils.ui").fg("Special"),
    }, opts or {})
    ...
    return {
        function(self)
            return M.format(self, (opts.icon and opts.icon .. " ") .. get(), "Special")
        end,
        cond = function()
